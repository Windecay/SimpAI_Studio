(function () {
    ...
    function createCanvasAgentVideoWorkflowController(context) {
        const scope = context?.videoWorkflowSource || context || {};
        ...
        const getMaxImageReferences = () => Math.max(0, Number(call(catalogSource, 'getMaxImageReferences', 0) || 0));
        ...
        const getCanvasAgentMediaReferenceNodes = (...args) => call(mediaSource, 'getCanvasAgentMediaReferenceNodes', {}, ...args);
        const canvasAgentMediaNodeCounts = (...args) => call(mediaSource, 'canvasAgentMediaNodeCounts', {}, ...args);
        const canvasAgentVideoTaskForMedia = (...args) => call(mediaSource, 'canvasAgentVideoTaskForMedia', '', ...args);
        const canvasAgentVideoTaskLabel = (...args) => call(mediaSource, 'canvasAgentVideoTaskLabel', '', ...args);
        ...
        const canvasAgentMediaNodeFacts = (...args) => call(mediaSource, 'canvasAgentMediaNodeFacts', [], ...args);
        ...
        const canvasAgentPresetSupportsMediaRequest = (...args) => call(catalogSource, 'canvasAgentPresetSupportsMediaRequest', true, ...args);
        const findCanvasAgentPresetEntryByAlias = (...args) => call(catalogSource, 'findCanvasAgentPresetEntryByAlias', null, ...args);
        const canvasAgentReferenceKey = (...args) => call(mediaSource, 'canvasAgentReferenceKey', (node => node?.id || ''), ...args);
        const getCanvasAgentExtraImageReferences = (...args) => call(mediaSource, 'getCanvasAgentExtraImageReferences', [], ...args);
        const canvasAgentReferenceNode = (...args) => call(mediaSource, 'canvasAgentReferenceNode', null, ...args);
        ...
        const connectCanvasAgentMediaToGenerator = (...args) => call(mediaSource, 'connectCanvasAgentMediaToGenerator', { ok: false }, ...args);
        const canvasAgentMediaConnectionError = (...args) => call(mediaSource, 'canvasAgentMediaConnectionError', '', ...args);
