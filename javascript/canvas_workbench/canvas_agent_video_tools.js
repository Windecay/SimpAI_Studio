(function () {
    ...
    function createCanvasAgentVideoToolsController(context) {
        const scope = context?.videoToolsSource || context || {};
        ...
        const getDefaultVideoErasePreset = () => String(call(catalogSource, 'getDefaultVideoErasePreset', '') || '');
        const getDefaultVideoReplacePreset = () => String(call(catalogSource, 'getDefaultVideoReplacePreset', '') || '');
        const getDefaultVideoFaceSwapPreset = () => String(call(catalogSource, 'getDefaultVideoFaceSwapPreset', '') || '');
        const getDefaultVideoFaceSwapTheme = () => String(call(catalogSource, 'getDefaultVideoFaceSwapTheme', '') || '');
        const getDefaultVideoMotionTransferPreset = () => String(call(catalogSource, 'getDefaultVideoMotionTransferPreset', '') || '');
        const getDefaultVideoMotionTransferTheme = () => String(call(catalogSource, 'getDefaultVideoMotionTransferTheme', '') || '');
        const getDefaultVideoUpscalePreset = () => String(call(catalogSource, 'getDefaultVideoUpscalePreset', '') || '');
        ...
        const canvasAgentPresetDefaultPromptForTheme = (...args) => call(promptSource, 'canvasAgentPresetDefaultPromptForTheme', '', ...args);
        ...
        const canvasAgentVideoSourceUploadSlot = (...args) => call(mediaSource, 'canvasAgentVideoSourceUploadSlot', '', ...args);
        ...
        const prepareCanvasAgentVideoMaskWorkflow = (...args) => call(workflowSource, 'prepareCanvasAgentVideoMaskWorkflow', { ok: false }, ...args);
        ...
        const findOpenNodePosition = (...args) => call(layoutSource, 'findOpenNodePosition', args[0] || { x: 0, y: 0 }, ...args.slice(1));
        const addLivePortraitExpressionNode = (...args) => call(nodeSource, 'addLivePortraitExpressionNode', null, ...args);
        const applyNodeLayoutPatch = (...args) => call(nodeSource, 'applyNodeLayoutPatch', {}, ...args) || {};
        const createLivePortraitExpressionImageEdge = (...args) => call(nodeSource, 'createLivePortraitExpressionImageEdge', null, ...args);
        const openLivePortraitExpressionEditor = (...args) => call(nodeSource, 'openLivePortraitExpressionEditor', null, ...args);
