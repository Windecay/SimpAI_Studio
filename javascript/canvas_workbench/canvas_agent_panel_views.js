(function () {
    ...
    function createCanvasAgentPanelViewsController(context) {
        ...
        const getCanvasAgentReferenceKind = (...args) => call(referenceSource, 'getCanvasAgentReferenceKind', '', ...args);
        const canvasAgentReferenceIcon = (...args) => call(referenceSource, 'canvasAgentReferenceIcon', 'fa-paperclip', ...args);
        const getCanvasAgentReferenceAsset = (...args) => call(referenceSource, 'getCanvasAgentReferenceAsset', null, ...args);
        const assetDisplaySrc = (...args) => call(referenceSource, 'assetDisplaySrc', '', ...args);
        const shouldEnableDanbooruAutocomplete = (...args) => call(autocompleteSource, 'shouldEnableDanbooruAutocomplete', false, ...args);
        const danbooruAutocompleteAttrs = (...args) => call(autocompleteSource, 'danbooruAutocompleteAttrs', '', ...args);
        const canvasAgentContextualQuickTools = (...args) => call(toolSource, 'canvasAgentContextualQuickTools', [], ...args) || [];
        const getMaxExtraImageReferences = () => Number(call(capacitySource, 'getMaxExtraImageReferences', 0) || 0);
        ...
        const getCanvasAgentResolutionState = (...args) => call(resolutionSource, 'getCanvasAgentResolutionState', { aspect: 'auto', multiplier: 1 }, ...args) || { aspect: 'auto', multiplier: 1 };
        const canvasAgentResolutionCompactLabel = (...args) => call(resolutionSource, 'canvasAgentResolutionCompactLabel', '', ...args);
        const getAspectOptions = (...args) => call(resolutionSource, 'getAspectOptions', [], ...args) || [];
        const canvasAgentModelSummary = (...args) => call(modelSource, 'canvasAgentModelSummary', { icon: 'fa-microchip', label: '', title: '' }, ...args) || { icon: 'fa-microchip', label: '', title: '' };
        const canvasAgentDefaultLocalRewriteModel = (...args) => call(modelSource, 'canvasAgentDefaultLocalRewriteModel', '', ...args);
        const canvasAgentLocalRewriteModels = (...args) => call(modelSource, 'canvasAgentLocalRewriteModels', [], ...args) || [];
        const vlmModelOptionsHtml = (...args) => call(modelSource, 'vlmModelOptionsHtml', '', ...args);
        const vlmModelDisplayLabel = (...args) => call(modelSource, 'vlmModelDisplayLabel', String(args[0] || ''), ...args);
        const getVlmCustomProvider = (...args) => call(customApiSource, 'getVlmCustomProvider', { label: 'Custom API', baseUrl: '' }, ...args) || { label: 'Custom API', baseUrl: '' };
        const canvasAgentCustomParamsFromSettings = (...args) => call(customApiSource, 'canvasAgentCustomParamsFromSettings', {}, ...args) || {};
        const getVlmCustomApiProfile = (...args) => call(customApiSource, 'getVlmCustomApiProfile', null, ...args);
        const getCanvasAgentCustomModelChoices = (...args) => call(customApiSource, 'getCanvasAgentCustomModelChoices', [], ...args) || [];
        const getCustomApiProviders = (...args) => call(customApiSource, 'getCustomApiProviders', [], ...args) || [];
        const canvasAgentPresetOptionHtml = (...args) => call(presetSource, 'canvasAgentPresetOptionHtml', '', ...args);
        const canvasAgentVideoQuickToolChoiceFromSettings = (...args) => call(presetSource, 'canvasAgentVideoQuickToolChoiceFromSettings', '', ...args);
        const canvasAgentVideoQuickToolChoiceOptionHtml = (...args) => call(presetSource, 'canvasAgentVideoQuickToolChoiceOptionHtml', '', ...args);
        const canvasAgentVideoUpscalePresetEntries = (...args) => call(presetSource, 'canvasAgentVideoUpscalePresetEntries', [], ...args) || [];
