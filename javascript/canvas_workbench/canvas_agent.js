(function () {
    ...
    window.SimpAICanvasWorkbenchCanvasAgent = Object.assign({}, window.SimpAICanvasWorkbenchCanvasAgent || {}, {
        ...
        CANVAS_AGENT_DEFAULT_AUDIO_TO_VIDEO_PRESET_QUEUE: ['MiniMax-H3(R2V)', 'LTX2.3(TA2V)', 'LTX2.3(IA2V)'],
        CANVAS_AGENT_DEFAULT_AUDIO_IMAGE_TO_VIDEO_PRESET_QUEUE: ['MiniMax-H3(R2V)', 'LTX2.3(IA2V)', 'LTX2.3(TA2V)'],
        ...
        CANVAS_AGENT_MAX_IMAGE_REFERENCES: 5,
        CANVAS_AGENT_MAX_EXTRA_IMAGE_REFERENCES: 4,
        CANVAS_AGENT_MAX_VIDEO_REFERENCES: 2,
