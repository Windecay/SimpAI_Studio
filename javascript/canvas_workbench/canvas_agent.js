(function () {
    ...
    window.SimpAICanvasWorkbenchCanvasAgent = Object.assign({}, window.SimpAICanvasWorkbenchCanvasAgent || {}, {
        ...
        CANVAS_AGENT_DEFAULT_REFERENCE_TO_VIDEO_PRESET_QUEUE: ['MiniMax-H3(R2V)'],
        CANVAS_AGENT_DEFAULT_AUDIO_TO_VIDEO_PRESET_QUEUE: ['MiniMax-H3(R2V)', 'LTX(TA2V)', 'LTX(IA2V)'],
        CANVAS_AGENT_DEFAULT_AUDIO_IMAGE_TO_VIDEO_PRESET_QUEUE: ['MiniMax-H3(R2V)', 'LTX(IA2V)', 'LTX(TA2V)'],
        ...
        CANVAS_AGENT_MAX_IMAGE_REFERENCES: 9,
        CANVAS_AGENT_MAX_EXTRA_IMAGE_REFERENCES: 8,
        CANVAS_AGENT_MAX_VIDEO_REFERENCES: 3,
        CANVAS_AGENT_MAX_AUDIO_REFERENCES: 3,
