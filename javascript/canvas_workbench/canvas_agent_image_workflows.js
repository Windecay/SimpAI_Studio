(function () {
    ...
    function createCanvasAgentImageWorkflowController(context) {
        const scope = context?.imageWorkflowSource || context || {};
        ...
        const normalizePresetName = typeof catalogSource.normalizePresetName === 'function'
            ? catalogSource.normalizePresetName
            : (value => String(value || '').trim());
        const getMaxExtraImageReferences = () => Math.max(0, Number(call(catalogSource, 'getMaxExtraImageReferences', 0) || 0));
        const refreshPresetCatalog = (...args) => call(catalogSource, 'refreshPresetCatalog', null, ...args);
        const getCanvasAgentTargetNode = (...args) => call(targetSource, 'getCanvasAgentTargetNode', null, ...args);
        const isCanvasAgentGeneratorTarget = (...args) => call(targetSource, 'isCanvasAgentGeneratorTarget', false, ...args);
        const getNode = (...args) => call(targetSource, 'getNode', null, ...args);
        const findCanvasAgentWorkflowPresetByKey = (...args) => call(targetSource, 'findCanvasAgentWorkflowPresetByKey', null, ...args);
        ...
        const chooseCanvasAgentPresetEntry = (...args) => call(catalogSource, 'chooseCanvasAgentPresetEntry', { entry: null, checked: [] }, ...args);
        const getPresetCatalog = (...args) => call(catalogSource, 'getPresetCatalog', [], ...args);
        const canvasAgentPresetSupportsTask = (...args) => call(catalogSource, 'canvasAgentPresetSupportsTask', false, ...args);
        const showToast = (...args) => call(stateSource, 'showToast', null, ...args);
        const canvasAgentPromptTargetFromNode = (...args) => call(promptSource, 'canvasAgentPromptTargetFromNode', {}, ...args);
        const canvasAgentPromptTargetFromEntry = (...args) => call(promptSource, 'canvasAgentPromptTargetFromEntry', {}, ...args);
        const ensureCanvasAgentPromptMatchesTarget = (...args) => call(promptSource, 'ensureCanvasAgentPromptMatchesTarget', { ok: true, prompt: '' }, ...args);
        const canvasAgentPresetPromptDefaults = (...args) => call(promptSource, 'canvasAgentPresetPromptDefaults', {}, ...args);
        const ensureCanvasAgentPromptPreflightAllows = (...args) => call(promptSource, 'ensureCanvasAgentPromptPreflightAllows', { ok: true, prompt: '' }, ...args);
        ...
        const canvasAgentPromptTargetFact = (...args) => call(promptSource, 'canvasAgentPromptTargetFact', null, ...args);
        ...
        const canvasAgentPresetPromptDefaultsFacts = (...args) => call(promptSource, 'canvasAgentPresetPromptDefaultsFacts', [], ...args);
        ...
        const findPresetCatalogEntryByName = (...args) => call(catalogSource, 'findPresetCatalogEntryByName', null, ...args);
        const vlmCanvasAgentWorkflowKey = (...args) => call(nodeSource, 'vlmCanvasAgentWorkflowKey', '', ...args);
        ...
        const applyCanvasAgentPresetDefaultsToGenerator = (...args) => call(nodeSource, 'applyCanvasAgentPresetDefaultsToGenerator', null, ...args);
        ...
        const getCanvasAgentPrimaryImageReference = (...args) => call(targetSource, 'getCanvasAgentPrimaryImageReference', null, ...args);
        const isCanvasAgentImageTarget = (...args) => call(targetSource, 'isCanvasAgentImageTarget', false, ...args);
        const canvasAgentReferenceNode = (...args) => call(targetSource, 'canvasAgentReferenceNode', null, ...args);
        const getCanvasAgentExtraImageReferences = (...args) => call(targetSource, 'getCanvasAgentExtraImageReferences', [], ...args);
        const previewCanvasAgentEditInputSlot = (...args) => call(mediaSource, 'previewCanvasAgentEditInputSlot', null, ...args);
        ...
        const applyCanvasAgentGenerationOptionsToGenerator = (...args) => call(generatorSource, 'applyCanvasAgentGenerationOptionsToGenerator', null, ...args);
        ...
        const setCanvasAgentSelection = (...args) => call(stateSource, 'setCanvasAgentSelection', null, ...args);
