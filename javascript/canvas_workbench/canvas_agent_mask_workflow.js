(function () {
    ...
    function createCanvasAgentMaskWorkflowController(source) {
        ...
        const getNodeLayerForgeAsset = (...args) => call('getNodeLayerForgeAsset', null, ...args);
        const assetMediaKind = (...args) => call('assetMediaKind', '', ...args);
        const assetDisplaySrc = (...args) => call('assetDisplaySrc', '', ...args);
        const getNodeImageSrc = (...args) => call('getNodeImageSrc', '', ...args);
        const createImageNodeFromSketchOutput = (...args) => call('createImageNodeFromSketchOutput', null, ...args);
        const ensureWorkbenchLazyRuntime = (...args) => call('ensureWorkbenchLazyRuntime', false, ...args);
        const getMaskUploadSlot = (...args) => call('canvasAgentMaskUploadSlot', '', ...args) || '';
        ...
        const syncResolutionConfigForPresetInputs = (...args) => call('syncResolutionConfigForPresetInputs', null, ...args);
        const generatedResultNodesForPreset = (...args) => call('generatedResultNodesForPreset', [], ...args) || [];
        const isResultRefreshing = (...args) => !!call('isResultRefreshing', false, ...args);
        ...
        const ensureGenerateEdge = (...args) => call('ensureGenerateEdge', null, ...args);
        const buildReservedResultNode = (...args) => call('buildReservedResultNode', null, ...args);
        const buildProjectNodeAppendPatch = (...args) => call('buildProjectNodeAppendPatch', {}, ...args) || {};
        const buildCanvasAgentReservedResultSource = (...args) => call('buildCanvasAgentReservedResultSource', {}, ...args) || {};
        const presetGenerationStepValue = (...args) => call('presetGenerationStepValue', 0, ...args);
        const presetResultBasePosition = (...args) => call('presetResultBasePosition', null, ...args);
        const defaultNodeSize = (...args) => call('defaultNodeSize', { w: 240, h: 260 }, ...args) || { w: 240, h: 260 };
