...
def check_base_environment():
    ...
    update_pkgs = [
        ('comfyui-frontend-package', '1.51.9', None),
        ('comfyui-workflow-templates', '0.11.50', None),
        ('comfyui-embedded-docs', '0.5.10', None),
        ('comfy-kitchen', '0.2.31', None),
        ('comfy-aimdo', '0.4.15', None),
        ('av', '17.0.0', None),
        ('PyOpenGL', None, '>=3.1.8'),
...
try:
    ...
    ensure_tipo_kgen_startup(python_executable=python)
except Exception as exc:
    logger.warning(f"TIPO dependency bootstrap failed: {type(exc).__name__}: {exc}")
