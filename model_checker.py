...
packages = {'base_package': {'id': 1,
 ...
 'bernini_r_package': {'id': 43,
                       ...
                       'preset_sample': []},
 'krea2_package': {'id': 44,
                   'name': '[44]Krea2文生图/图像编辑/动漫转真人模型包',
                   'note': 'Krea2 Turbo、Identity Edit与A2R共用模型包，包含Krea2 Turbo模型、Identity Edit v1.2与Anything2RealCharacters V3 LoRA、Qwen3VL 4B文本编码器|显存需求：★★★ 速度：★★★',
