...
def print_instructions():
    ...
    time.sleep(0.1)
    print(f"{Fore.GREEN}★{Style.RESET_ALL}疑难杂症进QQ群求助：1005085136{Fore.GREEN}★{Style.RESET_ALL}脚本：✿   冰華 |版本:26.09.13{Fore.GREEN}★{Style.RESET_ALL}")
    print()
    time.sleep(0.1)
...
packages = {'base_package': {'id': 1,
                  ...
                  'files': ['upscale_models,4x-UltraSharp.pth,66961958,0,https://www.modelscope.cn/models/metercai/SimpleSDXL2/resolve/master/SimpleModels/upscale_models/4x-UltraSharp.pth,https://huggingface.co/metercai/SimpleSDXL2/resolve/main/SimpleModels/upscale_models/4x-UltraSharp.pth',
                            ...
                            'ultralytics,bbox/face_yolov8m.pt,52026019,0,https://modelscope.cn/models/windecay/SimpAI_dev/resolve/master/SimpleModels/ultralytics/bbox/face_yolov8m.pt,https://huggingface.co/windecay/SimpleSDXL2/resolve/main/SimpleModels/ultralytics/bbox/face_yolov8m.pt',
                            'ultralytics,bbox/hand_yolov8s.pt,22507643,0,https://modelscope.cn/models/windecay/SimpAI_dev/resolve/master/SimpleModels/ultralytics/bbox/hand_yolov8s.pt,https://huggingface.co/windecay/SimpleSDXL2/resolve/main/SimpleModels/ultralytics/bbox/hand_yolov8s.pt'],
                  'info_links': [],
                  'preset_sample': []},
 'Qwen3_package': {'id': 2,
 ...
 'qwen_image_edit_plus_package': {'id': 6,
                                  ...
                                  'files': ['diffusion_models,qwen_image_edit_2511_fp8mixed.safetensors,20533762817,0,https://www.modelscope.cn/models/windecay/SimpAI_dev/resolve/master/SimpleModels/diffusion_models/qwen_image_edit_2511_fp8mixed.safetensors,https://huggingface.co/Comfy-Org/Qwen-Image-Edit_ComfyUI/resolve/main/split_files/diffusion_models/qwen_image_edit_2511_fp8mixed.safetensors',
                                            ...
                                            'loras,bfs_head_v5_2511_merged_version_rank_16_fp16.safetensors,307464216,0,https://www.modelscope.cn/models/Alissonerdx/BFS-Best-Face-Swap/resolve/20260309043408/bfs_head_v5_2511_merged_version_rank_16_fp16.safetensors,https://huggingface.co/Alissonerdx/BFS-Best-Face-Swap/resolve/main/bfs_head_v5_2511_merged_version_rank_16_fp16.safetensors',
                                            'detection,mediapipe_face_fp32.safetensors,5423900,0,https://www.modelscope.cn/models/Comfy-Org/mediapipe/resolve/master/detection/mediapipe_face_fp32.safetensors,https://huggingface.co/Comfy-Org/mediapipe/resolve/main/detection/mediapipe_face_fp32.safetensors',
                                  ...
                                  'preset_sample': []},
 'qwen-rapid-aio-nsfw': {'id': 7,
                         'name': '[7]Qwen-Rapid-AIO-NSFW',
 ...
 'Flux_aio_plus_package': {'id': 9,
                           ...
                           'preset_sample': []},
 'flux2-klein-9b-fp8': {'id': 10,
                        'name': '[10]Flux2-Klein-9B-FP8图像编辑&多打光&修复&漫转真',
                        ...
                        'preset_sample': []},
 'onekey_kontext_package': {'id': 11,
                            'name': '[11]OneKeyKontext一键精修预置包',
 ...
 'Swapface_package': {'id': 14,
                         ...
                         'preset_sample': []},
 'swap_plus_package': {'id': 15,
                           'name': '[15]Flux迁移、换装预置包',
 ...
 'extension_package': {'id': 16,
                       ...
                       'preset_sample': []},
 'Illustrious_package': {'id': 17,
                         'name': '[17]光辉模型包(喵咔V2.0)',
                         ...
                         'preset_sample': []},
 'Illustrious(OB)_aio_package': {'id': 18,
                              'name': '[18]光辉(OBv20)扩展包',
                              ...
                              'preset_sample': []},
 'chenking_aio_package': {'id': 19,
                              'name': '[19]ChenkingNoob-XL-V0.5扩展包',
 ...
 'sdxl_package': {'id': 20,
                  ...
                  'preset_sample': []},
 'SD15_aio_package': {'id': 21,
                      'name': '[21]SD1.5_AIO扩展包',
 ...
 'Depthstatue_package': {'id': 22,
                           ...
                           'preset_sample': []},
 'one_key_pose_package': {'id': 23,
                          'name': '[23]一键Pose骨骼图预置包',
 ...
 'LSnet_package': {'id': 24,
                   ...
                   'preset_sample': []},
 'wan_t2i_package': {'id': 25,
                     'name': '[25]Wan2.2_T2I文生图扩展包',
                     ...
                     'preset_sample': []},
 'wan_i2v_package': {'id': 26,
                     'name': '[26]Wan2.2图生视频扩展包',
                     ...
                     'preset_sample': []},
 'dasiwa_i2v_package': {'id': 27,
                     'name': '[27]Wan2.2_Dasiwa动漫向图生视频扩展包',
                     ...
                     'preset_sample': []},
 'wan_t2v_package': {'id': 28,
                     'name': '[28]Wan2.2文生视频扩展包',
                     ...
                     'info_links': ['https://modelscope.cn/models/Wan-AI/Wan2.2-T2V-A14B'],
                     'preset_sample': []},
 'wan_ttp_package': {'id': 29,
                     'name': '[29]Wan2.2_TTP超清放大扩展包',
                     ...
                     'info_links': ['https://modelscope.cn/models/Wan-AI/Wan2.2-T2V-A14B',
                                    'https://modelscope.cn/models/numz/SeedVR2_comfyUI'],
                     'preset_sample': []},
 'wan_scail_package': {'id': 30,
                       'name': '[30]Wan_SCAIL2扩展包',
                       ...
                       'files': ['diffusion_models,wan2.1_14B_SCAIL_2_int8_convrot.safetensors,16654506256,0,https://modelscope.cn/models/Comfy-Org/SCAIL-2/resolve/master/diffusion_models/wan2.1_14B_SCAIL_2_int8_convrot.safetensors,https://huggingface.co/Comfy-Org/SCAIL-2/resolve/main/diffusion_models/wan2.1_14B_SCAIL_2_int8_convrot.safetensors',
                                 ...
                                 'loras,wan2.1_SCAIL_2_relight_lora_bf16.safetensors,1226936552,0,https://modelscope.cn/models/Comfy-Org/SCAIL-2/resolve/master/loras/wan2.1_SCAIL_2_relight_lora_bf16.safetensors,https://huggingface.co/Comfy-Org/SCAIL-2/resolve/main/loras/wan2.1_SCAIL_2_relight_lora_bf16.safetensors',
                       ...
                       'preset_sample': []},
 "wan-animate-video-edit": {"id": 31,
                         "name": "[31]Wan-Animate-视频编辑",
                         ...
                         "preset_sample": []},
 'wan_infinitetalk': {'id': 32, 'name': '[32]Wan-InfiniteTalk对口型预置包',
                        ...
                        "preset_sample": []},
 'ltx_package': {'id': 33, 'name': '[33]LTX文生、图生音视频和视频配音预置包',
                    'note': 'LTX文生、图生音视频生成、视频外扩、视频配音预置包|显存需求：★★★☆ 速度：★★☆',
                    'files': [
                        'diffusion_models,ltx-2.5-22b-distilled-transformer-comfy-int8-convrot.safetensors,21504034224,0,https://www.modelscope.cn/models/Lightricks/LTX-2.5/resolve/master/diffusion_models/ltx-2.5-22b-distilled-transformer-comfy-int8-convrot.safetensors',
                        ...
                        'text_encoders,gemma4-12b-with-proj-ltx-2.5-comfy-int8-convrot.safetensors,15372969374,0,https://www.modelscope.cn/models/Lightricks/LTX-2.5/resolve/master/text_encoders/gemma4-12b-with-proj-ltx-2.5-comfy-int8-convrot.safetensors',
                        'vae,ltx-2.5-video-vae-bf16.safetensors,1472223346,0,https://www.modelscope.cn/models/Lightricks/LTX-2.5/resolve/master/vae/ltx-2.5-video-vae-bf16.safetensors',
                        'vae,ltx-2.5-audio-vae-bf16.safetensors,364866540,0,https://www.modelscope.cn/models/Lightricks/LTX-2.5/resolve/master/vae/ltx-2.5-audio-vae-bf16.safetensors',
                        'latent_upscale_models,ltx-2.5-latent-spatial-upscaler-x2-bf16-1.0.safetensors,995778752,0,https://www.modelscope.cn/models/Lightricks/LTX-2.5/resolve/master/latent_upscale_models/ltx-2.5-latent-spatial-upscaler-x2-bf16-1.0.safetensors',
                        ...
                        'controlnet,rife/flownet.pkl,24636301,0,https://www.modelscope.cn/models/windecay/rife/resolve/master/flownet.pkl,https://huggingface.co/windecay/SimpleSDXL2/resolve/main/SimpleModels/controlnet/rife/flownet.pkl'],
                    'info_links': ['https://www.modelscope.cn/models/Lightricks/LTX-2.5'],
                    'preset_sample': []},
 'hunyuan_foley_package': {'id': 34, 'name': '[34]腾讯混元Foley音效生成预置包',
                    ...
                    'preset_sample': []},
 'qwen_tts_0_6b': {'id': 35, 'name': '[35]Qwen3-TTS 0.6B模型包',
                        ...
                        "preset_sample": []},
 'qwen_tts_1_7b': {'id': 36, 'name': '[36]Qwen3-TTS 1.7B模型包',
 ...
 'bernini_r_package': {'id': 39,
                       ...
                       'note': 'Bernini ImageEdit、Bernini MultiI2V和Bernini VideoEdit共用模型包，包含Bernini-R双扩散模型、Bernini-R/Lightx2v LoRA、Wan VAE、umt5文本编码器和RIFE插帧模型|显存需求：★★★★☆ 速度：★',
                       ...
                       'preset_sample': []},
 'krea2_package': {'id': 40,
                   'name': '[40]Krea2全功能/图像编辑/动漫转真人模型包',
                   'note': 'Krea2 AIO、Identity Edit与A2R共用模型包，包含Depth、OpenPose控图与AnyPaint重绘LoRA、Identity Edit v1.2与Anything2RealCharacters V3 LoRA、Qwen3VL 4B文本编码器|显存需求：★★★ 速度：★★★',
                   'files': ['diffusion_models,krea2_turbo_int8_convrot.safetensors,13492686496,0,https://modelscope.cn/models/Comfy-Org/Krea-2/resolve/master/diffusion_models/krea2_turbo_int8_convrot.safetensors,https://huggingface.co/Comfy-Org/Krea-2/resolve/main/diffusion_models/krea2_turbo_int8_convrot.safetensors',
                             ...
                             'loras,Krea2_Anything2RealCharacters-V3.safetensors,228587720,0,https://modelscope.cn/models/zhouwenbin1994/Krea2_Anything2RealCharacters-V3/resolve/20260823031930/Krea2_Anything2RealCharacters-V3.safetensors,https://huggingface.co/WarmBloodAban/Krea2_Anything2RealCharacters/resolve/main/Krea2_Anything2RealCharacters-V3.safetensors',
                             'loras,depth-control-lora.safetensors,861995928,0,https://modelscope.cn/models/windecay/SimpAI_dev/resolve/master/SimpleModels/loras/depth-control-lora.safetensors,https://huggingface.co/Patil/Krea-2-depth-controlnet/resolve/main/depth-control-lora.safetensors',
                             'loras,krea2_turbo_openpose_controlnet.safetensors,228587504,0,https://modelscope.cn/models/windecay/SimpAI_dev/resolve/master/SimpleModels/loras/krea2_turbo_openpose_controlnet.safetensors,https://huggingface.co/thedeoxen/Krea-2-pose-controlnet/resolve/main/krea2_turbo_openpose_controlnet.safetensors',
                             'loras,krea2_anypaint_rank32.safetensors,228587752,0,https://modelscope.cn/models/windecay/SimpAI_dev/resolve/master/SimpleModels/loras/krea2_anypaint_rank32.safetensors,https://huggingface.co/yijunwang2/krea2-anypaint/resolve/main/krea2_anypaint_rank32.safetensors',
                   ...
                   'info_links': ['https://modelscope.cn/models/krea/Krea-2-Turbo',
                                  'https://huggingface.co/WarmBloodAban/Krea2_Anything2RealCharacters',
                                  'https://www.modelscope.cn/models/hf/conradlocke-krea2-identity-edit'],
                   'preset_sample': []},
 'liveportrait_exp_package': {'id': 41,
                              'name': '[41]LivePortrait Exp表情编辑模型包',
                              'note': 'LivePortrait 图像/视频表情编辑模型包，包含LivePortrait核心模型和人脸检测模型|显存需求：★ 速度：★★★★',
                              ...
                              'preset_sample': []},
 'wan_uni3c_t2v_package': {'id': 42,
                           'name': '[42]Wan Uni3C T2V运镜模型包',
                           'note': 'Wan-Uni3C(T2V) 模型包，使用Wan2.1 T2V模型搭配Uni3C控制模型，输入参考视频控制摄像机运动|显存需求：★★★★ 速度：★',
                           ...
                           'preset_sample': []},
 'minimax_h3_package': {'id': 43,
                        'name': '[43]MiniMax H3文生、图生、多参考图、片段重建模型包',
                        'note': 'MiniMax H3文生视频、首尾帧图生视频、多参考图视频生成与片段重建模型包，含 ControlNet 和 RIFE；视频生成支持原生音频|显存需求：★★★★ 速度：★',
                        'files': ['diffusion_models,minimax_h3_hybrid_fl2va_ref2va_b25-49-int8.safetensors,20970379632,0,https://modelscope.cn/models/windecay/SimpAI_dev/resolve/master/SimpleModels/diffusion_models/minimax_h3_hybrid_fl2va_ref2va_b25-49-int8.safetensors,https://huggingface.co/smhfacct/Minimax-H3-fl2va-ref2va-hybrid-models/resolve/main/minimax_h3_hybrid_fl2va_ref2va_b25-49-int8.safetensors',
                                  ...
                                  'model_patches,minimax_h3_fun_controlnet_union_pruned_int8_convrot.safetensors,2296635360,0,https://modelscope.cn/models/Comfy-Org/MiniMax-H3/resolve/master/model_patches/minimax_h3_fun_controlnet_union_pruned_int8_convrot.safetensors,https://huggingface.co/Comfy-Org/MiniMax-H3/resolve/main/model_patches/minimax_h3_fun_controlnet_union_pruned_int8_convrot.safetensors',
                                  'controlnet,rife/flownet.pkl,24636301,0,https://www.modelscope.cn/models/windecay/rife/resolve/master/flownet.pkl,https://huggingface.co/windecay/SimpleSDXL2/resolve/main/SimpleModels/controlnet/rife/flownet.pkl',
                                  'insightface,models/buffalo_l/det_10g.onnx,16923827,0,https://www.modelscope.cn/models/metercai/SimpleSDXL2/resolve/master/SimpleModels/insightface/models/buffalo_l/det_10g.onnx,https://huggingface.co/metercai/SimpleSDXL2/resolve/main/SimpleModels/insightface/models/buffalo_l/det_10g.onnx',
                                  'detection,mediapipe_face_fp32.safetensors,5423900,0,https://www.modelscope.cn/models/Comfy-Org/mediapipe/resolve/master/detection/mediapipe_face_fp32.safetensors,https://huggingface.co/Comfy-Org/mediapipe/resolve/main/detection/mediapipe_face_fp32.safetensors',
                                  'controlnet,dw-ll_ucoco_384.onnx,134399116,0,https://www.modelscope.cn/models/zhangjin/DWPose/resolve/master/dw-ll_ucoco_384.onnx,https://huggingface.co/yzd-v/DWPose/resolve/main/dw-ll_ucoco_384.onnx',
                                  'insightface,models/buffalo_l/w600k_r50.onnx,174383860,0,https://www.modelscope.cn/models/metercai/SimpleSDXL2/resolve/master/SimpleModels/insightface/models/buffalo_l/w600k_r50.onnx,https://huggingface.co/metercai/SimpleSDXL2/resolve/main/SimpleModels/insightface/models/buffalo_l/w600k_r50.onnx'],
                        'info_links': ['https://modelscope.cn/models/Comfy-Org/MiniMax-H3'],
                        'preset_sample': []},
 'topaz_starlight_package': {'id': 44,
                             'name': '[44]Topaz Starlight SLP-26视频超分/增强资源包',
