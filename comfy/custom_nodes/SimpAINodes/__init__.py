...
NODE_MODULES = [
    ("VRGDG_MiniMaxH3AudioDrive", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIH3SourceAudioTiming", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIH3VideoTransition", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIH3TransitionConditioning", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIH3FirstLastFrameConditioning", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIH3TemporalRepaint", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIH3RegionRebuild", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIH3DetailRefine", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIH3MotionControl", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIAnimaLoraRemap", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ...
    ("SimpAIMiniMaxH3SigmaRefiner", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ...
    ("SimpAIMiniMaxH3AdaptiveReference", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ...
    ("SimpAIKrea2OstrisEdit", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIKrea2AIO", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAILTXVFrameLength", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIVideoFrameAlign", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIFaceTrack", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ("SimpAIFaceIdentityTrack", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
    ...
    ("SimpAITopazStarlight", "NODE_CLASS_MAPPINGS", "NODE_DISPLAY_NAME_MAPPINGS"),
]
