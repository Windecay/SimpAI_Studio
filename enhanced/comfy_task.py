...
def get_comfy_task(user_did, task_class, task_name, task_method, default_params, input_images, options=None):
    ...
    if "scene_" in task_method_l or task_class in ("Qwen", "Wan", "Z-image"):
        ...
        comfy_params.update_mapping_rule("i2i_ip_image5", "SceneInput:SceneInput:ip_image4")
        comfy_params.update_mapping_rule("i2i_ip_image6", "SceneInput:SceneInput:ip_image5")
        ...
        comfy_params.update_mapping_rule("video", "SimpAIH3RegionSource:H3 Region Source:video")
